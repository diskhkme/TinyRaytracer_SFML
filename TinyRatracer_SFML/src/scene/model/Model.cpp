...
Model::Model(const char * filename, const Material & m)
	: ModelBase{ m }, verts{}, faces{},
	bboxMin{}, bboxMax{}
{
	LoadModel(filename);
}
...
bool Model::ray_aabb_intersect(const Vec3f &orig, const Vec3f &dir) const
{
...
// Moller and Trumbore
bool Model::ray_triangle_intersect(const int &fi, const Vec3f &orig, const Vec3f &dir, float &tnear, Vec3f& normal) const {
...
bool Model::RayIntersect(const Vec3f & orig, const Vec3f & dir, 
